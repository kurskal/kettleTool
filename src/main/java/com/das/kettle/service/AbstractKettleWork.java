...
public class AbstractKettleWork implements KettleWork {
     ...
     */
    @Override
    public void init(String kettleName) throws KettleException, KettleWorkPathException {
        SlaveServer slaveServer = initRemoteSlaveServer();
    ...
    public SlaveServer initRemoteSlaveServer(){return null;};
